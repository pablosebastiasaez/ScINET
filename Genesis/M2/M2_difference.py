...
import numpy as np
import sys
from scatter_cython import diff_integral
...
name=f'scatter_{rank}_diff_{it}.npz'
np.savez(name,
        kx=X0,
        ky=Y0,
        kz=Z0,
